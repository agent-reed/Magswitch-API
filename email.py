...
os.system("echo \"Hey everybody! Here are the statistics for the Mobile App over the past week.\n\nMost Viewed Products: \n #1: %s \n #2: %s \n #3: %s \n #4: %s \n #5 %s \n\nNumber of new users: %s \n\nTotal Users Today: %s \n\nNumber of unique logins: %s\" | mail -s \"Weekly Stat Update\" -t andrew.gentry@colorado.edu ceo@magswitch.com.au kdeforest@magswitch.com.au ddalpiaz@magswitch.com.au edrennen@magswitch.com.au"%(weeklyproducts[0][0], weeklyproducts[1][0], weeklyproducts[2][0], weeklyproducts[3][0], weeklyproducts[4][0], newusers, thisHigh[0], weeklyLogins))
